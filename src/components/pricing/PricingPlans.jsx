    ...
    <PageShell>
        <section className="relative z-10 w-full max-w-5xl">
            ...
            <div className="grid grid-cols-1 items-stretch gap-8 md:grid-cols-2">
                <section className="pricing-card flex flex-col justify-between rounded-3xl border border-slate-800/80 bg-slate-900/30 p-8 shadow-xl backdrop-blur-xl">
                ...
                <section className="pricing-card pricing-featured relative flex flex-col justify-between rounded-3xl border-2 border-indigo-500 bg-gradient-to-b from-slate-900/80 to-slate-900/40 p-8 shadow-2xl shadow-indigo-600/5 backdrop-blur-xl">
