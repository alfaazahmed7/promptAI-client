...
const PageShell = ({ children }) => (
    <main className="pricing-page relative flex min-h-screen w-full flex-col items-center overflow-hidden bg-[#011627] px-4 pb-16 pt-36">
        <div className="pricing-glow pointer-events-none absolute left-1/3 top-1/4 hidden h-[500px] w-[500px] -translate-x-1/2 rounded-full bg-indigo-600/10 blur-[140px] md:block" />
        <div className="pricing-glow pointer-events-none absolute bottom-1/4 right-1/3 hidden h-[500px] w-[500px] translate-x-1/2 rounded-full bg-[#dc2f02]/10 blur-[140px] md:block" />
        {children}
    </main>
);
    ...
    <PageShell>
        <section className="relative z-10 w-full max-w-5xl">
            <motion.div
                ...
                className="pricing-premium-hero relative overflow-hidden rounded-3xl border border-emerald-400/25 bg-gradient-to-br from-emerald-500/15 via-slate-900/80 to-indigo-950/60 p-7 shadow-2xl shadow-emerald-950/20 sm:p-10"
            >
                ...
                <div className="relative flex flex-col gap-7 sm:flex-row sm:items-start sm:justify-between">
                    ...
                    <div className="pricing-details flex shrink-0 items-center gap-3 rounded-2xl border border-emerald-400/20 bg-[#071c2a]/70 p-4 backdrop-blur-sm">
            ...
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="mt-8 grid grid-cols-1 gap-8 rounded-3xl border border-slate-700/60 bg-slate-900/35 p-6 shadow-xl backdrop-blur-xl sm:p-8 md:grid-cols-[1.4fr_1fr]">
                ...
                <div className="pricing-details rounded-2xl border border-indigo-500/20 bg-[#071c2a]/70 p-5">
    ...
    <PageShell>
        <section className="relative z-10 w-full max-w-5xl">
            ...
            <div className="grid grid-cols-1 items-stretch gap-8 md:grid-cols-2">
                <section className="pricing-card flex flex-col justify-between rounded-3xl border border-slate-800/80 bg-slate-900/30 p-6 sm:p-8 shadow-xl backdrop-blur-xl">
                ...
                <section className="pricing-card pricing-featured relative flex flex-col justify-between rounded-3xl border-2 border-indigo-500 bg-gradient-to-b from-slate-900/80 to-slate-900/40 p-6 sm:p-8 shadow-2xl shadow-indigo-600/5 backdrop-blur-xl">
