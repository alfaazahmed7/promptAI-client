// src/components/FeaturedPromptsSkeleton.jsx
import React from 'react';

const FeaturedPromptsSkeleton = () => {
    return (
        <div className="w-full py-24 flex flex-col items-center justify-center antialiased bg-[#0B1220]">
...
export default FeaturedPromptsSkeleton;